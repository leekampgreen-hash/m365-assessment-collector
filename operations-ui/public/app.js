...
async function loadNewPanels() {
  ...
  panelCards("#intune-enrollment-cards", [["💻", "Total enrolled", es.total_enrolled ?? es.total_devices ?? 0, "ENROLLED"], ["🪟", "Windows", os.Windows ?? os.windows ?? 0], ["📱", "Mobile", Number(os.iOS ?? os.ios ?? 0) + Number(os.Android ?? os.android ?? 0)], ["🏢 / 👤", "Company owned vs Personal", `${owners.company ?? owners.company_owned ?? 0} / ${owners.personal ?? 0}`]]);
